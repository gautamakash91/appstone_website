...
import integrationIllustration from "@/assets/representation-user-experience-interface-design.jpg";
    ...
    <section className="bg-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 pb-12 pt-10 md:flex-row md:items-start md:justify-between md:gap-12 md:pb-16 md:pt-14">
        ...
        <p className="max-w-2xl text-lg leading-8 text-[#888D97]">
          We have expertise in mobile app development in addition to web app
          development. These software programs are used on mobile devices such
