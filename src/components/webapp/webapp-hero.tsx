...
import integrationIllustration from "@/assets/03-Web-App-Development_1.webp";
    ...
    <section className="bg-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 pb-12 pt-10 md:flex-row md:items-start md:justify-between md:gap-12 md:pb-16 md:pt-14">
        ...
        <p className="max-w-2xl text-lg leading-8 text-[#888D97]">
          We have expertise in web app development, which entails producing
          application programs hosted on distant servers and supplied to a
          user's device through the Internet.
        </p>
      </div>
