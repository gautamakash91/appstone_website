...
const DevOpsEngineeringSection = ({
  title,
  fullDescription,
  subHeading,
  subDescription,
  ...
  return (
    <section className="bg-[#f5f9fc] py-12 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 items-stretch">
        ...
        {/* ✅ Image First on lg, Second on small screens */}
        ...
        {/* ✅ Content First on small screens, Second on lg */}
...
export default DevOpsEngineeringSection;
