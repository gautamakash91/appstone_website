...
import integrationIllustration from "@/assets/standard-quality-control-concept-m.jpg";
    ...
    <section className="bg-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 pb-12 pt-10 md:flex-row md:items-start md:justify-between md:gap-12 md:pb-16 md:pt-14">
        ...
        <p className="max-w-2xl text-lg leading-8 text-[#888D97]">
          We integrate by connecting the design, delivery, and evaluation of
          programs across disciplines and sectors, and enhancing longer-lasting
