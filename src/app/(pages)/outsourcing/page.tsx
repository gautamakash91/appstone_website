...
import integrationIllustration from "@/assets/hands-with-laptop-virtual-world-map.jpg";
import OutsourcingOverview from "@/components/outsourcing/outsourcing-overview";
    ...
    <section className="bg-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 pb-12 pt-10 md:flex-row md:items-start md:justify-between md:gap-12 md:pb-16 md:pt-14">
        ...
        <p className="max-w-2xl text-lg leading-8 text-[#888D97]">
          At Appstone, Outsourcing is the practice of engaging with a
          third-party expert to assist a business in executing its software
          development project responsibilities more efficiently and effectively.
        </p>
      </div>
